...
public class PlotSettings {
    ...
    public enum Type {
        ...
        DAY_TIME_CHANGE(Constants.CONFIGURATION.getDouble("plot.settings.DAY_TIME_CHANGE"), DayTimeChange.getInstance(), object -> object == null ? null : String.valueOf(object), string -> string.equals("null") ? null : Long.parseLong(string), new Tuple[]{Tuple.of("Świt", 0L), Tuple.of("Rano", 1000L), Tuple.of("Południe", 6000L), Tuple.of("Zachód słońca", 12000L), Tuple.of("Zmierzch", 13000L), Tuple.of("Noc", 14000L), Tuple.of("Północ", 18000L), Tuple.of("Domyślna pora dnia", null)}),
