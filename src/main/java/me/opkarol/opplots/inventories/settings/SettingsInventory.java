...
public class SettingsInventory {
    ...
    public static GuiItem getChosenItem(Player player, PlotSettings.Type type, String identifier, Plot plot, Material material, Runnable runnable) {
        ...
        ItemBuilder itemBuilder = new ItemBuilder(material)
                ...
                .setLore("&7Posiadasz: " + StringIconUtil.getReturnedEmojiFromBoolean(isOwned), "&7Aktywny: " + StringIconUtil.getReturnedEmojiFromBoolean(isCurrent), isOwned ? "&7Wykupione!" : "&7Cena: #<447cfc>" + cost);
        if (isCurrent) {
